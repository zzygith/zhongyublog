        ...
        <div className="resume">
          ...
          <center>
            <p>
              <a
                ...
                rel="noreferrer"
              >
                <strong>Github:</strong> github.com/zzygith
              </a>
              <br />
              <a
                ...
                rel="noreferrer"
              >
                <strong>Linkedin:</strong> linkedin.com/in/zhongyu-zhang-profile
              </a>
               
              <a
                href="mailto: zhangzhongyu98@gmail.com"
                target="_blank"
                rel="noreferrer"
              >
                <strong>Email:</strong> zhangzhongyu98@gmail.com
              </a>
            </p>
          </center>
          <h2>Education</h2>
          ...
          <div>
            <div>
              ...
              <span style={{ float: "right" }}>Edmonton, Alberta, Canada</span>
            </div>
            <br />
            <div>
              Master's Degree&emsp;Electrical and Computer
              Engineering&emsp;GPA:3.8/4.0
            </div>
            <br />
            <div>
              <a
                href="https://www.en.sdu.edu.cn"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <span style={{ float: "right" }}>Jinan, Shandong, China</span>
            </div>
            <br />
            <div>Bachelor‘s Degree&emsp;Automation&emsp;GPA:83.66/100</div>
          </div>
          <br />
          <h2>Skills</h2>
          <hr />
          ...
          <p>
            <em>GatsbyJS &#x26; CSS Modules &#x26; GraphQL</em>
          </p>
          <p>
            Demo URL：
            <a
              href="https://www.webzhongyu.com"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <ul style={{ listStylePosition: "inside" }}>
            ...
            <li>Accessed markdown files and other data using GraphQL</li>
            <li>
          ...
          <p>
            Demo URL：
            <a
              href="https://chatui-show.netlify.app"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <p>
            Demo URL：
            <a
              href="https://backstage-show.netlify.app"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <p>
            <em>Python &#x26; OpenCV &#x26; OpenPose</em>
          </p>
          <p>
            Demo URL：
            <a
              href="https://github.com/zzygith/pose-detection"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <p>
            Demo URL：
            <a
              href="https://github.com/zzygith/Recognition-and-Classification-of-Paper-Plastic-Bags"
              target="_blank"
              rel="noreferrer"
            >
